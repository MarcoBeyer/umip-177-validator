...
export class OptimisticOracleV3__factory {
  static readonly abi = _abi;
  static createInterface(): OptimisticOracleV3Interface {
    return new Interface(_abi) as OptimisticOracleV3Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): OptimisticOracleV3 {
    return new Contract(address, _abi, runner) as unknown as OptimisticOracleV3;
  }
}
